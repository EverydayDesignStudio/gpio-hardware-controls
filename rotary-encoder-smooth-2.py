...
# GPIO Ports
Enc_A = 20  # Encoder input A: input GPIO 20 (active high)
Enc_B = 21  # Encoder input B: input GPIO 21 (active high)
...
def init():
    ...
    # pull-ups are too weak, they introduce noise
